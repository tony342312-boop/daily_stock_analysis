...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "EXA_API_KEYS": {
        "title": "Exa API Keys",
        "description": "Comma-separated Exa API keys for semantic web/news search with highlights.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "SEC_EDGAR_ENABLED": {
        ...
        "description": "Enable SEC EDGAR submissions/companyfacts for US stock financial reports and public filing links.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "SEC_EDGAR_USER_AGENT": {
        ...
        "description": "Declared User-Agent for SEC fair access, ideally app name plus contact email.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "daily_stock_analysis/1.0 admin@stock.cn.mt",
        "options": [],
        "validation": {},
        "display_order": 33,
    },
    "SEC_EDGAR_TIMEOUT_SECONDS": {
        "title": "SEC EDGAR Timeout",
        "description": "Timeout budget in seconds for SEC EDGAR US-stock fundamentals.",
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "FRED_API_KEY": {
        "title": "FRED API Key",
        "description": "St. Louis Fed FRED API key for US macro indicators such as Treasury yields, CPI, unemployment, and fed funds.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "FRED_ENABLED": {
        ...
        "description": "Enable FRED macro indicators for US-stock reports when FRED_API_KEY is configured.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "FRED_TIMEOUT_SECONDS": {
        "title": "FRED Timeout",
        "description": "Timeout budget in seconds for FRED macro indicator requests.",
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "PEER_VALUATION_ENABLED": {
        "title": "Peer Valuation Comparison",
        "description": "Enable same-type peer valuation comparison using realtime quote PE/PB/market-cap fields.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "PEER_VALUATION_TIMEOUT_SECONDS": {
        "title": "Peer Valuation Timeout",
        "description": "Timeout budget in seconds for peer valuation comparison.",
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "PEER_VALUATION_MAX_PEERS": {
        "title": "Peer Valuation Max Peers",
        "description": "Maximum number of peer tickers included in one valuation comparison.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "US_PEER_VALUATION_MAP": {
        "title": "US Peer Valuation Map",
        "description": "Optional JSON override for US peer groups, e.g. {\"AAPL\":[\"DELL\",\"HPQ\",\"SONY\"]}.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "textarea",
        "is_sensitive": False,
    ...
    "CN_PEER_VALUATION_MAP": {
        "title": "CN Peer Valuation Map",
        "description": "Optional JSON override for A-share peer groups, e.g. {\"600519\":[\"000858\",\"000568\"]}.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "textarea",
        "is_sensitive": False,
    ...
    "HK_PEER_VALUATION_MAP": {
        "title": "HK Peer Valuation Map",
        "description": "Optional JSON override for HK peer groups, e.g. {\"HK00700\":[\"HK09999\",\"HK03690\"]}.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "textarea",
        "is_sensitive": False,
    ...
    "DDG_SEARCH_ENABLED": {
        ...
        "description": "Enable DuckDuckGo HTML search as a free no-key fallback.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "GOOGLE_NEWS_RSS_ENABLED": {
        ...
        "description": "Enable Google News RSS as a free no-key news fallback.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "BING_NEWS_RSS_ENABLED": {
        "title": "Bing News RSS",
        "description": "Enable Bing News RSS as a free no-key news fallback.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "MULTI_SEARCH_ENGINE_ENABLED": {
        "title": "Multi Search Engine",
        "description": "Aggregate enabled free search fallbacks and de-duplicate results.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
